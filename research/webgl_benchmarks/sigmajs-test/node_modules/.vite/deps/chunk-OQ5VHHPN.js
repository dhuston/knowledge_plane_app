...
var S = (0, import_react.forwardRef)(({ graph: e2, id: n2, className: r2, style: a2, settings: o2 = {}, children: m2 }, f2) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (null !== p2.current) {
      let n3 = new Graph();
      e2 && (n3 = "function" == typeof e2 ? new e2() : e2), t2 = new Sigma$1(n3, p2.current, O2), w2 && t2.getCamera().setState(w2.getCamera().getState());
    }
    return E2(t2), () => {
      t2 && t2.kill(), E2(null);
    };
...
//# sourceMappingURL=chunk-OQ5VHHPN.js.map
