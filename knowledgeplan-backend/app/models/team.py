...
if TYPE_CHECKING:
    ...
    # from .department import Department # noqa: F401 # If Department model exists
...
class Team(Base):
    ...
    members = relationship("User", back_populates="team", foreign_keys=[User.team_id]) # One-to-many: Team has many Users
