    ...
    if center_node_id:
        ...
        if depth == 2:
            ...
            for neighbor_id, neighbor_type in depth1_neighbor_tuples:
                ...
                # We don't need to go deeper, so no need to store depth 2 tuples

    else:
        # --- Existing User-Centric Context Logic --- 
        print(f"Fetching user-centric view for user: {current_user.id}") # Log
