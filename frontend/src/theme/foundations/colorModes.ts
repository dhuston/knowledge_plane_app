...
const semanticColors: NestedColorModeObject = {
  ...
  text: {
    primary: {
      ...
      _dark: 'secondary.400', // Light gray/almost white
    },
    secondary: {
    ...
    tertiary: {
      _light: 'primary.600', // Deeper blue
      _dark: 'primary.400',
    },
    disabled: {
      _light: 'gray.400',
    ...
    inverse: {
      _light: 'secondary.400', // Light gray/almost white
  ...
  bg: {
    ...
    highlight: {
      _light: 'primary.300', // Light blue
      _dark: 'primary.600', // Deeper blue
    },
    card: {
      _light: 'surface.500', // White
      _dark: '#363636', // Slightly lighter than button color
...
const shadows: NestedColorModeObject = {
  ...
  card: {
    _light: '0 4px 6px rgba(59, 130, 246, 0.08)',
    _dark: '0 4px 6px rgba(0, 0, 0, 0.3)',
  },
  'card-hover': {
    _light: '0 8px 12px rgba(59, 130, 246, 0.12)',
    _dark: '0 8px 12px rgba(0, 0, 0, 0.4)',
  },
  modal: {
    _light: '0 20px 25px rgba(59, 130, 246, 0.15)',
    _dark: '0 20px 25px rgba(0, 0, 0, 0.4)',
  },
  // Adjust focus shadow for dark mode
  focus: {
    _light: '0 0 0 3px rgba(59, 130, 246, 0.5)', // Blue with transparency
    _dark: '0 0 0 3px rgba(96, 165, 250, 0.5)', // Lighter blue with transparency
  },
};
