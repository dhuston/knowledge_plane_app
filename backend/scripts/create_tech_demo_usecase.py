...
3. Teams with proper structure
4. Knowledge assets and relationships
"""
...
async def create_tech_demo_usecase():
    ...
    async with async_session() as session:
        ...
        # 2. Create departments if they don't exist
        departments = [
        ...
        for dept in departments:
            ...
            """
            dept_result = await execute_query(session, 
                                             dept_check_query, 
                                             {"tenant_id": tenant_id, "name": dept["name"]})
        ...
        # 3. Create teams if they don't exist
        teams = [
        ...
        # 4. Create regular users if needed
        users_data = [
        ...
        # 5. Update teams with lead_id (first user in each team becomes the lead)
        for team in teams:
        ...
        # 6. Create goals with strategic alignment focus
        goals = [
            {
        ...
        # 7. Create projects with real-world technology use cases
        projects = [
            {
