...
class UserInDBBase(UserBase):
    id: UUID  # Use UUID instead of UUID4 for flexibility
    tenant_id: UUID  # Use UUID instead of UUID4 for flexibility
    created_at: Optional[datetime] = None  # Make optional to handle mock users
    updated_at: Optional[datetime] = None
    last_login_at: Optional[datetime] = None
    team_id: Optional[UUID] = None  # Use UUID instead of UUID4 for flexibility
    manager_id: Optional[UUID] = None  # Use UUID instead of UUID4 for flexibility
    auth_provider: Optional[str] = None
    auth_provider_id: Optional[str] = None
    google_access_token: Optional[str] = None
    google_refresh_token: Optional[str] = None
